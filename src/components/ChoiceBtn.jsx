...
function ChoiceBtn({ text, setToForm, styleImg, style, grade, defaultValue }) {
  let srcImage = personne;
  if (text == "Student")
    srcImage = student
  ...
  return (
    ...
    >  
      ...
      <img className={"absolute lg:left-11 left-9 lg:w-20 w-20 lg:h-20 h-20 top-1/2 -translate-y-1/2 max-[568px]:h-14 max-[568px]:w-14 " + styleImg} src={text == "Student" ? student : personne} alt="personne" />
